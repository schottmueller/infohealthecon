...
** Risk premium
*** Example
Flip a fair coin: If heads you have 10.000\euro  as annual income, if tails 20.000\euro . What is your expected income? If you could get X\euro  for sure as income, how high has X to be to make you indifferent?
...
# - consider more lotteries and put more points
...
*** 							    :B_ignoreheading:
    ...
    :END:
Result:
- partial coverage if consumption is less attractive in ill state
