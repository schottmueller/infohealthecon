...
* News
- The faculty has decided today to switch all on campus exams in March to online exams (on the same date). Also the second exam in the summer term will be online. Details about the procedure will be published at a later date on this website.
