...
* News
- Unfortunately, I still did not receive a confirmation regarding the exam date. Our latest attempt was to get a room for June 15. However, as we did not get a confirmation yet it seems questionable whether this will work out.
