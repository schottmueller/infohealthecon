...
* News
  - Exam dates are Feb 21, 15:00 (100 Aula 1) and March 30 17:00 (105 HS A1). Registration is open on KLIPS.
...
- *Notes*
  - concerning the exercise sessions (beware that these do not contain verbal explanations given in the session and that they do not constitute model solutions)
    ...
    - [[https://github.com/schottmueller/infohealthecon/files/7746152/Session.10.Notes.pdf][Session 10]]
