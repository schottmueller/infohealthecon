...
* News
- Exam results for the exam from Fevruary 3rd are published now by the examination office. The exam inspection will be after the start of the new term in April. More detailled information will follow at a later date.
